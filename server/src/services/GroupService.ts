...
export class GroupService {
    ...
    private messageRepository: GroupRepository;

    constructor() {
        this.messageRepository = getCustomRepository(GroupRepository);
    }
    ...
    public findMessageByUser = async (user: User) => {
        const messages = await this.messageRepository.findGroupByUser(user)
        return messages;
    }
